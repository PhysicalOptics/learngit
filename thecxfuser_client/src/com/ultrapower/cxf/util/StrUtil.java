...
public class StrUtil {
    ...
    /**
     * �Ƚ�比较两个字符串是否相同，如果两个字符串为null�?""均视为相同且忽略大小�?
     * 
     * create by yangwm in Nov 4, 2008 8:52:57 PM
     * 
     * @param str1
    ...
    /**
     * 比较两个字符串是否相同，如果两个字符串为null�?""�?"null"均视为相�? create by yangwm in Nov 4, 2008
     * 8:52:57 PM
     * 
     * @param str1
     * @param str2
    ...
    /**
     * �ַ字符串是否为空, null�?""�?"null"均视为空 create by yangwm in Nov 5, 2008 3:59:24 PM
     * 
     * @param value
     * @return
     */
    ...
    /**
     * 将字符串str格式化为 �?00002345”的形式。如果str为null或�?��?��?�，或�?�无法格式化为数字，则返回null�?
     * 
     * @param str
     * @return
     */
    ...
    /**
     * 判断字符串是否是全部由�??0’组成�?�如果str为null或�?��?��?�，则返回false
     * @param str
     * @return
     */
    ...
    /**
     *将String字符串前边填充位数的无意义的�?0”字符去�?
     * @Date May 31, 2011
     * @author duyonggang
     * @param String 原字符串形式�?:"00000130"
     * @return String 去除前边填充的�??0”后的字符串形式�?:"130"
     */
    ...
    /**
	 * 将字符串用特点的字符分隔成独立元素，比如“G|T张三G|T李四G|T”，替换成�?�张�?;李四�?
	 * 
	 * @method splitStr2Single
	 * @param str
	 *            �?要拆分的字符�?
	 * @param str1
	 *            �?要拆分的字符串中含有的特殊字符，比如上例中的G|T
	 * @param str2
	 *            每个独立元素中分隔字符，比如上例中的;
	 * @author linxinzheng
	 * @return
	 */
	public static String splitStr2Single(String str, String str1, String str2) {
		if (!isNullStr(str) && !isNullStr(str1) && !isNullStr(str2)) {
			str = str.replaceAll(str1, str2);
			// 如果替换后的字符串中含有多个str2，�?�过正则替换�?1个，比如：�?�张�?;;李四”，替换成�?�张�?;李四�?
			str = str.replaceAll("[" + str2 + "]+", str2);
			if (str.startsWith(str2)) {
				str = str.replaceFirst(str2, "");
			}
			if (!StrUtil.isNullStr(str) && str.endsWith(str2)) {
	...
	/**
     * @Title: isNumeric
     * @Description: 判断字符串是否整�?
     * @author xiaoxuepeng
     * @date 2013-12-30 下午02:49:35
     * @param str 字符�?
     * @return 返回�?
     */
